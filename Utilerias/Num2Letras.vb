Public Class Num2Letras
	...
	'
	' ©Guillermo 'guille' Som, 1991-2000
	'------------------------------------------------------------------------------
	...
	Public Function Numero2Letra(ByVal strNum As String, Optional ByVal Lo As Integer = 0, Optional ByVal NumDecimales As Integer = 2, Optional ByVal sMoneda As String = "", Optional ByVal sCentimos As String = "", Optional ByVal SexoMoneda As eSexo = eSexo.Femenino, Optional ByVal SexoCentimos As eSexo = eSexo.Masculino) As String
		...
		If iHayDecimal Then
            ...
            '30 lo convierte en 3, eso está mal
	...
	Public Function UnNumero(ByVal strNum As String, ByVal Sexo1 As String) As String
		'----------------------------------------------------------
	...
	Public Function NumeroALetra(ByVal strNum As String, Optional ByVal Lo As Integer = 0, Optional ByVal NumDecimales As Integer = 2, Optional ByVal sMoneda As String = "", Optional ByVal sCentimos As String = "", Optional ByVal SexoMoneda As eSexo = eSexo.Femenino, Optional ByVal SexoCentimos As eSexo = eSexo.Masculino) As String
		...
		If iHayDecimal Then
			...
			End If
			'
			' Linea Original -->  strNum = sEntero & sMoneda & "con " & sFraccion & sCentimos
			strNum = sEntero & " " & MiDecimal & "/100" ' Sin nada mas
			If Lo Then
				sNumero = LSet(RTrim(strNum), Len(sNumero))
			Else
				sNumero = RTrim(strNum)
