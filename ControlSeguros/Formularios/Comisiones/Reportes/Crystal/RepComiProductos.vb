...
Public Class RepComiProductos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.RepComiProductos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepComiProductos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepComiProductos = New RepComiProductos
        rpt.Site = Me.Site
        Return rpt
    End Function
