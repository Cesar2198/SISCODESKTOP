...
Partial Class CondicionesEspNav
    ...
    Private Sub InitializeComponent()
        ...
        Me.FormularioEdicion = "CondicionesEspMan"
        Me.ListaAliasCampos = "Cod. Condicion, IdRamo, Ramo , Descripción"
        Me.ListaCampos = "IdCondicion, IdRamo,(select NombreRamo from RamoSeguros where RamoSeguros.idramo " & _
            "= CondicionesEspeciales.idramo ) as Ramo , Descripcion"
        Me.ListaCamposLlave = "IdCondicion"
        Me.ListaCamposOcultos = " IdRamo"
        Me.Name = "CondicionesEspNav"
        Me.OrdenRegistros = " IdRamo, cast(Descripcion as varchar(500))"
        Me.Tabla = "CondicionesEspeciales"
        Me.Text = "Condiciones Especiales de Pólizas"
