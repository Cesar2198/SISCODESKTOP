...
Public Class RepClientesTarjeta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.RepClientesTarjeta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepClientesTarjeta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepClientesTarjeta = New RepClientesTarjeta
        rpt.Site = Me.Site
        Return rpt
    End Function
