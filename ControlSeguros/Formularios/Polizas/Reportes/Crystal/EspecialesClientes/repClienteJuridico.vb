...
Public Class repClienteJuridico
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.repClienteJuridico.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepClienteJuridico
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repClienteJuridico = New repClienteJuridico
        rpt.Site = Me.Site
        Return rpt
    End Function
