...
Public Class RepDetPolizaRR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.RepDetPolizaRR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepDetPolizaRR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepDetPolizaRR = New RepDetPolizaRR
        rpt.Site = Me.Site
        Return rpt
    End Function
