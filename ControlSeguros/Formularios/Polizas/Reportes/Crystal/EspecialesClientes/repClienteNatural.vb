...
Public Class repClienteNatural
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.repClienteNatural.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepClienteNatural
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repClienteNatural = New repClienteNatural
        rpt.Site = Me.Site
        Return rpt
    End Function
