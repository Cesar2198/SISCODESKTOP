...
Public Class RepCierreOferta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.RepCierreOferta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepCierreOferta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepCierreOferta = New RepCierreOferta
        rpt.Site = Me.Site
        Return rpt
    End Function
