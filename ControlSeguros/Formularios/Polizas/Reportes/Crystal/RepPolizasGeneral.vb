...
Public Class RepPolizasGeneral
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.RepPolizasGeneral.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepPolizasGeneral
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepPolizasGeneral = New RepPolizasGeneral
        rpt.Site = Me.Site
        Return rpt
    End Function
