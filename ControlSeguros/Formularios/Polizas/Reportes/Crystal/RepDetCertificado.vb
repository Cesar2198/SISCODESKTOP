...
Public Class RepDetCertificado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.RepDetCertificado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepDetCertificado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepDetCertificado = New RepDetCertificado
        rpt.Site = Me.Site
        Return rpt
    End Function
