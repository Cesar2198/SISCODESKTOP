...
Public Class RepPolizasCanceladas
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RepPolizasCanceladas.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.RepPolizasCanceladas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepPolizasCanceladas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepPolizasCanceladas = New RepPolizasCanceladas
        rpt.Site = Me.Site
        Return rpt
    End Function
