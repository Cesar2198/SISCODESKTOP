...
Public Class RepFichaCliente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.RepFichaCliente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepFichaCliente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepFichaCliente = New RepFichaCliente
        rpt.Site = Me.Site
        Return rpt
    End Function
