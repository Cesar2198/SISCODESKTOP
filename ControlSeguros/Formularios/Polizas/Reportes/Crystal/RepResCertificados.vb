...
Public Class RepResCertificados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.RepResCertificados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepResCertificados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepResCertificados = New RepResCertificados
        rpt.Site = Me.Site
        Return rpt
    End Function
