...
Public Class RepDetPolizaIncendio
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RepDetPolizaIncendio.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.RepDetPolizaIncendio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepDetPolizaIncendio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepDetPolizaIncendio = New RepDetPolizaIncendio
        rpt.Site = Me.Site
        Return rpt
    End Function
