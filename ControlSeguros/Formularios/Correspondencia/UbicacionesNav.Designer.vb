...
Partial Class UbicacionesNav
    ...
    Private Sub InitializeComponent()
        ...
        Me.FormularioEdicion = "UbicacionesMan"
        Me.ListaAliasCampos = "Cod. Ubicacion, Descripción, Cod. Cliente, Nombre Cliente, Ciudad"
        Me.ListaCampos = "IdUbicacion, Descripcion, IdCliente, NombreCliente, (select NombreCiudad from Ciu" & _
            "dades where ciudades.idciudad = ubicaciones.idciudad )"
        Me.ListaCamposLlave = "IdUbicacion"
        Me.Name = "UbicacionesNav"
        Me.OrdenRegistros = "cast(Descripcion as varchar(max))"
        Me.Tabla = "Ubicaciones"
