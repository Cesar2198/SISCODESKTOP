...
Partial Class CorrespondenciaNav
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(CorrespondenciaNav))
        Me.SuspendLayout()
        '
        'btnEliminar
        '
        ...
        Me.FormularioEdicion = "Correspondencia"
        ...
        Me.ListaCamposOcultos = "Vendedor, UsuarioAsignacion, UsuarioReAsignacion, FechaAsignacion, FechaReAsignac" & _
            "ion,Identificador,IdImpresionFinal,TipoFlujo"
        Me.Name = "CorrespondenciaNav"
        Me.OrdenRegistros = "FechaInicia desc"
        Me.Tabla = "FlujosDocumentos"
        Me.Text = "Detalle Correspondencia"
