...
Partial Class MunicipiosNav
    ...
    Private Sub InitializeComponent()
        ...
        Me.FormularioEdicion = "MunicipiosMan"
        Me.ListaAliasCampos = "Cod. Municipio, Nombre Municipio, Departamento"
        Me.ListaCampos = "IdMunicipio, NombreMunicipio, (select NombreDepartamento from Departamentos where" & _
            " Departamentos.IdDepartamento = Municipios.IdDepartamento)"
        Me.ListaCamposLlave = "IdMunicipio"
        Me.Name = "MunicipiosNav"
        Me.OrdenRegistros = "3,2"
        Me.Tabla = "Municipios"
        Me.Text = "Municipios"
