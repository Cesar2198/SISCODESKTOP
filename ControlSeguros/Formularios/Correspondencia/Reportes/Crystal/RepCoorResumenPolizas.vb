...
Public Class RepCoorResumenPolizas
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RepCoorResumenPolizas.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.RepCoorResumenPolizas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepCoorResumenPolizas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepCoorResumenPolizas = New RepCoorResumenPolizas
        rpt.Site = Me.Site
        Return rpt
    End Function
