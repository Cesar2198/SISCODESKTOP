...
Public Class RepCartaCobroRR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.RepCartaCobroRR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepCartaCobroRR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepCartaCobroRR = New RepCartaCobroRR
        rpt.Site = Me.Site
        Return rpt
    End Function
