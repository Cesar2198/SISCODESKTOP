...
Partial Class PagosAsegNav
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(PagosAsegNav))
        ...
        Me.FormularioEdicion = "PagosAsegMan"
        Me.ListaAliasCampos = "Cod. Pago , Cod. Aseguradora, Aseguradora, Número Cheque, Banco, Fecha Cheque, Va" & _
            "lor Cheque, Comentarios"
        Me.ListaCampos = resources.GetString("$this.ListaCampos")
        Me.ListaCamposLlave = "IdPago"
        Me.ListaCamposOcultos = "IdAseguradora, IdPago, Comentario"
        Me.Name = "PagosAsegNav"
        Me.OrdenRegistros = "FechaCheque desc,  IdAseguradora"
        Me.Tabla = "PagosAseguradoras"
        Me.Text = "Pagos de Aseguradoras"
