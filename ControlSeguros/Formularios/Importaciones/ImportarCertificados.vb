...
Public Class ImportarCertificados
        ...
        Try
            ...
            Select Case NombreColumna
                ...
                Case "CERTIFICADO", "CERT."
                    Res = "G|IdCertificado|"
                Case "CERTIFICADO.ASEG."
                    Res = "G|IdCertificadoAseguradora|"
                ...
                Case "PARTICIPACION"
                    Res = "G|Participacion|"
                Case "FECHAEXCLUSION"
                    Res = "G|FechaExclusion|"
                Case "MOTIVOEXCLUSION"
                    Res = "G|RazonExclusion|"
    ...
    Private Function CrearCertificado(ByRef Hoja As Object, ByVal Fila As Integer) As String
        ...
        Dim estadoCert As String = "VIGENTE"
        If HayDatoArchivo(Hoja, Fila, "FechaExclusion") = True Or HayDatoArchivo(Hoja, Fila, "RazonExclusion") = True Then estadoCert = "CANCELADO"
        ...
        If Existe = 0 Then
            ...
            sql &= " PorceDescuento, ValorDescuento, PrimaBruta, IdPlan, IdCertificadoAseguradora) values ("
            ...
            sql &= dbNum(GastosB) & C & dbNum(GastosO) & C & dbNum(Iva) & C & dbNum(Total) & C & dbStr(estadoCert) & C & dbFec(ObtenerDatoArchivo(Hoja, Fila, "FechaExclusion")) & C
            ...
            sql &= dbNum(PorceDescuento) & C & dbNum(ValorDescuento) & C & dbNum(PrimaBruta) & C & dbStr(ObtenerDatoArchivo(Hoja, Fila, "IdPlan"), 25) & C & dbStr(ObtenerDatoArchivo(Hoja, Fila, "IdCertificadoAseguradora"), 25) & ")"
            ...
            StiGlobalConn.SQLExecute(sql)
        Else
            sql = "  update PolizasCertificados set idpoliza = idpoliza"

            If chkUpdate.Checked = False Or (Me.chkUpdate.Checked = True And HayDatoArchivo(Hoja, Fila, "IdCliente") = True) Then _
            sql &= " , IdCliente = " & dbStr(ObtenerDatoArchivo(Hoja, Fila, "IdCliente"), 25)
            If chkUpdate.Checked = False Or (Me.chkUpdate.Checked = True And HayDatoArchivo(Hoja, Fila, "NombreCliente") = True) Then _
            sql &= " , NombreCliente = " & dbStr(ObtenerDatoArchivo(Hoja, Fila, "NombreCliente"), 150)
            If chkUpdate.Checked = False Or (Me.chkUpdate.Checked = True And HayDatoArchivo(Hoja, Fila, "FechaInclusion") = True) Then _
            sql &= " , FechaInclusion = " & dbFec(ObtenerDatoArchivo(Hoja, Fila, "FechaInclusion"))
            If chkUpdate.Checked = False Or (Me.chkUpdate.Checked = True And HayDatoArchivo(Hoja, Fila, "VigenciaDesde") = True) Then _
            sql &= " , VigenciaDesde = " & dbFec(VigenciaDesde)
            If chkUpdate.Checked = False Or (Me.chkUpdate.Checked = True And HayDatoArchivo(Hoja, Fila, "VigenciaHasta") = True) Then _
            sql &= " , VigenciaHasta = " & dbFec(VigenciaHasta)
            If chkUpdate.Checked = False Or (Me.chkUpdate.Checked = True And HayDatoArchivo(Hoja, Fila, "ValorAsegurado") = True) Then _
            sql &= " , ValorAsegurado = " & dbNum(ObtenerDatoArchivo(Hoja, Fila, "ValorAsegurado"))
            If chkUpdate.Checked = False Or (Me.chkUpdate.Checked = True And HayDatoArchivo(Hoja, Fila, "PrimaNeta") = True) Then _
            sql &= " , PrimaNeta = " & dbNum(PrimaNeta)
            If chkUpdate.Checked = False Or (Me.chkUpdate.Checked = True And HayDatoArchivo(Hoja, Fila, "GastosEmi") = True) Then _
            sql &= " , GastosEmi = " & dbNum(GastosE)
            If chkUpdate.Checked = False Or (Me.chkUpdate.Checked = True And HayDatoArchivo(Hoja, Fila, "GastosFrac") = True) Then _
            sql &= " , GastosFrac = " & dbNum(GastosF)
            If chkUpdate.Checked = False Or (Me.chkUpdate.Checked = True And HayDatoArchivo(Hoja, Fila, "GastosBomb") = True) Then _
            sql &= " , GastosBomb = " & dbNum(GastosB)
            If chkUpdate.Checked = False Or (Me.chkUpdate.Checked = True And HayDatoArchivo(Hoja, Fila, "GastosOtros") = True) Then _
            sql &= " , GastosOtros = " & dbNum(GastosO)
            If chkUpdate.Checked = False Or (Me.chkUpdate.Checked = True And HayDatoArchivo(Hoja, Fila, "Iva") = True) Then _
            sql &= " , Iva = " & dbNum(Iva)
            If chkUpdate.Checked = False Or (Me.chkUpdate.Checked = True And HayDatoArchivo(Hoja, Fila, "Total") = True) Then _
            sql &= " , Total = " & dbNum(Total)
            sql &= " , EstadoCertificado = " & dbStr(estadoCert)
            If chkUpdate.Checked = False Or (Me.chkUpdate.Checked = True And HayDatoArchivo(Hoja, Fila, "FechaExclusion") = True) Then _
            sql &= " , FechaExclusion = " & dbFec(ObtenerDatoArchivo(Hoja, Fila, "FechaExclusion"))
            If chkUpdate.Checked = False Or (Me.chkUpdate.Checked = True And HayDatoArchivo(Hoja, Fila, "RazonExclusion") = True) Then _
            sql &= " , RazonExclusion = " & dbStr(ObtenerDatoArchivo(Hoja, Fila, "RazonExclusion"), 50)
            If chkUpdate.Checked = False Or (Me.chkUpdate.Checked = True And HayDatoArchivo(Hoja, Fila, "Deducible") = True) Then _
            sql &= " , Deducible = " & dbStr(ObtenerDatoArchivo(Hoja, Fila, "Deducible"), 50)
            If chkUpdate.Checked = False Or (Me.chkUpdate.Checked = True And HayDatoArchivo(Hoja, Fila, "Participacion") = True) Then _
            ...
            If chkUpdate.Checked = False Or (Me.chkUpdate.Checked = True And HayDatoArchivo(Hoja, Fila, "PorceDescuento") = True) Then _
            sql &= " , PorceDescuento = " & dbNum(PorceDescuento)
            If chkUpdate.Checked = False Or (Me.chkUpdate.Checked = True And HayDatoArchivo(Hoja, Fila, "ValorDescuento") = True) Then _
            sql &= " , ValorDescuento = " & dbNum(ValorDescuento)
            If chkUpdate.Checked = False Or (Me.chkUpdate.Checked = True And HayDatoArchivo(Hoja, Fila, "PrimaBruta") = True) Then _
            sql &= " , PrimaBruta = " & dbNum(PrimaBruta)
            If chkUpdate.Checked = False Or (Me.chkUpdate.Checked = True And HayDatoArchivo(Hoja, Fila, "IdCertificadoAseguradora") = True) Then _
            sql &= " , IdCertificadoAseguradora = " & dbStr(ObtenerDatoArchivo(Hoja, Fila, "IdCertificadoAseguradora"), 25)
    ...
    Private Function HayDatoArchivo(ByRef Hoja As Object, ByVal Fila As Integer, ByVal Campo As String) As Boolean
        Dim res As Boolean = False
        Try
            Dim Columna As Integer = ObtenerColCampo(Campo)
            If Columna > 0 Then
                If CStr(Hoja.Cells(Fila, Columna).Value) <> "" Then res = True
            End If
        Catch ex As Exception
            res = False
        End Try
    ...
    Private Function HayDatoArchivo(ByRef Hoja As Object, ByVal Fila As Integer, ByVal Columna As Integer) As Boolean
        Dim res As Boolean = False
        Try
            If Columna > 0 And Fila > 0 Then
                If CStr(Hoja.Cells(Fila, Columna).Value) <> "" Then res = True
    ...
    Private Sub CrearCoberturas(ByRef Hoja As Object, ByVal Fila As Integer, ByVal IdCertificado As String)
        ...
        Dim Suma As String = "", haySuma As Boolean = False
        Dim Tasa As String = "", hatTasa As Boolean = False
        Dim Deducible As String = "", hayDedu As Boolean = False
        Dim Prima As String = "", hayPrim As Boolean = False
        Dim Porce As String = "", hayPors As Boolean = False
        Dim ColDato As Integer
        Dim PrimaAnual As String = "", hayPria As Boolean = False
        Dim existe As Integer = 0

        If chkUpdate.Checked = False Then StiGlobalConn.SQLExecute("delete from PolizasCoberturas where IdPoliza = " & dbStr(IdPolizaActual, 25) & " and IdProducto = " & dbStr(IdProductoActual, 25) & " and IdCertificado = " & dbStr(IdCertificado, 25))
        ...
        For Each Filcob In Coberturas.Rows
            ...
            If ColDato > 0 Then
                haySuma = HayDatoArchivo(Hoja, Fila, ColDato)
            ...
            If ColDato > 0 Then
                hatTasa = HayDatoArchivo(Hoja, Fila, ColDato)
            ...
            If ColDato > 0 Then
                hayDedu = HayDatoArchivo(Hoja, Fila, ColDato)
            ...
            If ColDato > 0 Then
                hayPrim = HayDatoArchivo(Hoja, Fila, ColDato)
            ...
            If ColDato > 0 Then
                hayPria = HayDatoArchivo(Hoja, Fila, ColDato)
            ...
            If ColDato > 0 Then
                hayPors = HayDatoArchivo(Hoja, Fila, ColDato)
            ...
            If chkUpdate.Checked = False Then
                existe = 0
            Else
                existe = StiGlobalConn.ObtenerDataset("select count(*) from PolizasCoberturas where IdPoliza = " & dbStr(IdPolizaActual, 25) & " and IdProducto = " & dbStr(IdProductoActual, 25) & " and IdCertificado = " & dbStr(IdCertificado, 25) & " and IdCobertura = " & dbInt(dbData(Filcob, "IdCobertura"))).Tables(0).Rows(0).Item(0)
            End If
            If existe = 0 Then
            ...
            Else
                sql = " update PolizasCoberturas set idpoliza = idpoliza"
                If haySuma = True Then sql &= " , SumaAsegurada =  " & dbNum(Suma)
                If hatTasa = True Then sql &= " , Tasa = " & dbNum(Tasa)
                If hayDedu = True Then sql &= " , Deducible = " & dbStr(Deducible)
                If hayPrim = True Then sql &= " , Prima = " & dbNum(Prima)
                If hayPors = True Then sql &= " , PorceSuma = " & dbNum(Porce)
                sql &= " , AplicarDescuento = " & dbStr(dbData(Filcob, "AplicarDescuento"))
                If hayPria = True Then sql &= " , PrimaAnual = " & dbNum(PrimaAnual)
                sql &= " where IdPoliza = " & dbStr(IdPolizaActual, 25)
                sql &= " and IdProducto = " & dbStr(IdProductoActual, 25)
                sql &= " and IdCertificado = " & dbStr(IdCertificado, 25)
                sql &= " and IdCobertura = " & dbInt(dbData(Filcob, "IdCobertura"))
            End If
            StiGlobalConn.SQLExecute(sql)
    ...
    Private Sub CrearBienes(ByRef Hoja As Object, ByVal Fila As Integer, ByVal IdCertificado As String)
        ...
        If Me.chkUpdate.Checked = False Then StiGlobalConn.SQLExecute("delete from PolizasBienes where IdPoliza = " & dbStr(IdPolizaActual, 25) & " and IdProducto = " & dbStr(IdProductoActual, 25) & " and IdCertificado = " & dbStr(IdCertificado, 25))
        For NC As Integer = 0 To Me.VistaImportar.DataRowCount - 1
            If VistaImportar.GetRowCellValue(NC, "Tipo") = "B" And VistaImportar.GetRowCellValue(NC, "Campo") <> "" Then
                Try
                    ...
                    If Valor <> "" Then
                        If Me.chkUpdate.Checked = False Then
                            IdBien += 1
                        ...
                        Else
                            dtexiste = StiGlobalConn.ObtenerDataset("select * from PolizasBienes where IdPoliza = " & dbStr(IdPolizaActual) & " and IdProducto = " & dbStr(IdProductoActual) & " and IdCertificado = " & dbStr(IdCertificado) & " and NombreBien = " & dbStr(VistaImportar.GetRowCellValue(NC, "Campo"))).Tables(0)
                            Select Case dtexiste.Rows.Count
                                Case 0
                                    Try
                                        IdBien = StiGlobalConn.ObtenerDataset("select isnull(max(IdBien),0) from PolizasBienes where IdPoliza = " & dbStr(IdPolizaActual) & " and IdProducto = " & dbStr(IdProductoActual) & " and IdCertificado = " & dbStr(IdCertificado)).Tables(0).Rows(0).Item(0)
                                    Catch ex As Exception
                                        IdBien = 0
                                    End Try
                                    IdBien += 1
                                    ...
                                    StiGlobalConn.SQLExecute(sql)
                                Case 1
                                    sql = "  update PolizasBienes "
                                    sql &= " set DescripcionBien = " & dbStr(Valor)
                                    sql &= " where IdPoliza = " & dbStr(IdPolizaActual)
                                    sql &= " and IdProducto = " & dbStr(IdProductoActual)
                                    sql &= " and IdCertificado = " & dbStr(IdCertificado)
                                    sql &= " and IdBien = " & dbInt(dbData(dtexiste.Rows(0), "IdBien"))
                                    sql &= " and NombreBien = " & dbStr(VistaImportar.GetRowCellValue(NC, "Campo"))
                                    StiGlobalConn.SQLExecute(sql)
                                Case Else
                                    'si hay mas de una instancia del mismo nombre de bien no hacemos nada no podemos determinar cual dato es
                            End Select
                        End If
                    End If
                Catch ex As Exception
    ...
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        ...
        Try
            ...
            Hoja.Cells(Fila, 10).Value = "CERTIFICADO.ASEG."
            Hoja.Cells(Fila, 11).Value = "COD.CLIENTE"
            Hoja.Cells(Fila, 12).Value = "NOMBRE CLIENTE"
            Hoja.Cells(Fila, 13).Value = "FECHA.INCLUSION"
            Hoja.Cells(Fila, 14).Value = "FECHA EXCLUSION"
            Hoja.Cells(Fila, 15).Value = "MOTIVO EXCLUSION"
            Hoja.Cells(Fila, 16).Value = "VIGENCIA.DESDE"
            Hoja.Cells(Fila, 17).Value = "VIGENCIA.HASTA"
            Hoja.Cells(Fila, 18).Value = "SUMA ASEGURADA"
            Hoja.Cells(Fila, 19).Value = "PRIMA BRUTA"
            Hoja.Cells(Fila, 20).Value = "PORCE.DESCUENTO"
            Hoja.Cells(Fila, 21).Value = "DESCUENTOS"
            Hoja.Cells(Fila, 22).Value = "PRIMA NETA"
            Hoja.Cells(Fila, 23).Value = "GASTOS EMISION"
            Hoja.Cells(Fila, 24).Value = "GASTOS FRACCIONAMIENTO"
            Hoja.Cells(Fila, 25).Value = "GASTOS BOMBEROS"
            Hoja.Cells(Fila, 26).Value = "OTROS GASTOS"
            Hoja.Cells(Fila, 27).Value = "IMPUESTOS"
            Hoja.Cells(Fila, 28).Value = "PRIMA TOTAL"
            Hoja.Cells(Fila, 29).Value = "DEDUCIBLE"
            Hoja.Cells(Fila, 30).Value = "PARTICIPACION"
