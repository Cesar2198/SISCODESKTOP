...
Public Class ImportarFacturas
    ...
    Private Sub btnNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevo.Click
        ...
        Try
            ...
            Hoja.Cells(Fila, 31).Value = "PRIMA_EXENTA"
    ...
    Private Function ProcesarFactura(ByRef Hoja As Object, ByVal Fila As Integer, ByVal Analizar As Boolean) As String
        ...
        If Existe > 0 Then
            If res = "" Then
                ...
                If ExisteCampo("DocumentoFiscal") = True Then
                    Try
                        If ObtenerDatoArchivo(Hoja, Fila, "Referencia").Trim <> "" Then
                            StiGlobalConn.SQLExecute("update facturas set DocumentoFiscal = " & dbStr(ObtenerDatoArchivo(Hoja, Fila, "Referencia").Trim) & " where NumeroFactura = " & dbInt(NumeroFactura) & " and IdProducto = " & dbStr(IdProducto) & " and IdPoliza = " & dbStr(Poliza) & " and IdRamo =  " & dbStr(IdRamo))
                        End If
