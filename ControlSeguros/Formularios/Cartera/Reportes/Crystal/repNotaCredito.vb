...
Public Class repNotaCredito
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.repNotaCredito.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepNotaCredito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repNotaCredito = New repNotaCredito
        rpt.Site = Me.Site
        Return rpt
    End Function
