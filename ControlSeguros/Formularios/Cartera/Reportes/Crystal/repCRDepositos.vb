...
Public Class repCRDepositos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.repCRDepositos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepCRDepositos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repCRDepositos = New repCRDepositos
        rpt.Site = Me.Site
        Return rpt
    End Function
