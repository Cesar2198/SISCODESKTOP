...
Public Class repAvisoCobroRAS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.repAvisoCobroRAS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepAvisoCobroRAS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repAvisoCobroRAS = New repAvisoCobroRAS
        rpt.Site = Me.Site
        Return rpt
    End Function
