...
Public Class repAvisoCobroNR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.repAvisoCobroNR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepAvisoCobroNR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repAvisoCobroNR = New repAvisoCobroNR
        rpt.Site = Me.Site
        Return rpt
    End Function
