...
Public Class repAvisoCobroPryma
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.repAvisoCobroPryma.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepAvisoCobroPryma
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repAvisoCobroPryma = New repAvisoCobroPryma
        rpt.Site = Me.Site
        Return rpt
    End Function
