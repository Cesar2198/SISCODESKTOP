...
Public Class repAvisoCobroAdrisa
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "repAvisoCobroAdrisa.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.repAvisoCobroAdrisa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepAvisoCobroAdrisa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repAvisoCobroAdrisa = New repAvisoCobroAdrisa
        rpt.Site = Me.Site
        Return rpt
    End Function
