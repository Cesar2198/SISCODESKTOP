...
Public Class repAvisoCobroCoaseg
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "repAvisoCobroCoaseg.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.repAvisoCobroCoaseg.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepAvisoCobroCoaseg
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repAvisoCobroCoaseg = New repAvisoCobroCoaseg
        rpt.Site = Me.Site
        Return rpt
    End Function
