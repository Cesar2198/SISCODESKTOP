...
Public Class repAvisoCobroRR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.repAvisoCobroRR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepAvisoCobroRR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repAvisoCobroRR = New repAvisoCobroRR
        rpt.Site = Me.Site
        Return rpt
    End Function
