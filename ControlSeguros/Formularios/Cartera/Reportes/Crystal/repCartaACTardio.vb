...
Public Class repCartaACTardio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.repCartaACTardio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepCartaACTardio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repCartaACTardio = New repCartaACTardio
        rpt.Site = Me.Site
        Return rpt
    End Function
