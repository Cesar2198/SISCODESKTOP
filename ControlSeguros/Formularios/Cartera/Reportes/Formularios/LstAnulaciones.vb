...
Public Class LstAnulaciones

    Private Sub btnSalir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSalir.Click
        Me.Close()
    End Sub

    Private Sub LstAnulaciones_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub btnImprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnImprimir.Click
        Try
            ...
            sql &= ",isnull(m.MotivoAnulacion,'ANULACION') as Motivo"
            ...
            sql &= " and m.TipoMovimiento = 'ANULACION'"
            ...
            If dtPagos.Rows.Count = 0 Then
                MsgBox("No se han encontrado anulaciones con las condiciones especificadas.", MsgBoxStyle.Information, "AVISO...")
                Exit Sub
            End If
            ...
            SetRepFormulaString(Reporte, "Titulo1", "Reporte de Anulación de Facturas/Créditos Fiscales")
            SetRepFormulaString(Reporte, "Titulo2", "Anulaciones entre el " & Format(txtFechaDesde.Valor, "dd/MMM/yyyy") & " y el " & Format(txtFechaHasta.Valor, "dd/MMM/yyyy"))
