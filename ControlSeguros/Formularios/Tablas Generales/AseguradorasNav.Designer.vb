...
Partial Class AseguradorasNav
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(AseguradorasNav))
        ...
        Me.FormularioEdicion = "AseguradorasMan"
        Me.ListaAliasCampos = "Cod. Aseguradora,Nombre Aseguradora,Dirección,Teléfono,Fax,Correo Electrónico,Sit" & _
            "io Web,Nit,Registro Fiscal,Cod. Agente, Abreviatura, Estado Aseguradora"
        Me.ListaCampos = resources.GetString("$this.ListaCampos")
        Me.ListaCamposLlave = "IdAseguradora"
        Me.ListaCamposOcultos = "Direccion,EMail,PaginaWeb,Nit,RegistroFiscal,CodAgente"
        Me.Name = "AseguradorasNav"
        Me.OrdenRegistros = "IdAseguradora"
        Me.Tabla = "Aseguradoras"
