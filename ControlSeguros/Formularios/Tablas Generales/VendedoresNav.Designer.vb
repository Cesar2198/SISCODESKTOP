...
Partial Class VendedoresNav
    ...
    Private Sub InitializeComponent()
        ...
        Me.FormularioEdicion = "VendedoresMan"
        Me.ListaAliasCampos = "Cod. Vendedor,Nombre Vendedor, Dirección, Teléfono, Fax, Correo Electrónico, Nit," & _
            " Registro Fiscal,Giro, Credencial SSF, Tipo Vendedor, Estado"
        Me.ListaCampos = "IdVendedor,NombreVendedor, Direccion, Telefono, Fax, EMail, Nit, RegistroFiscal,G" & _
            "iro, CredencialSSF, IdTipoVendedor, IdEstado"
        Me.ListaCamposLlave = "IdVendedor"
        Me.ListaCamposOcultos = "IdVendedor, Direccion, Nit, RegistroFiscal,Giro"
        Me.Name = "VendedoresNav"
        Me.OrdenRegistros = "IdVendedor"
        Me.Tabla = "Vendedores"
