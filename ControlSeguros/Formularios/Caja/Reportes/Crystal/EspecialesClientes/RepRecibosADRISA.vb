...
Public Class RepRecibosADRISA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.RepRecibosADRISA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepRecibosADRISA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepRecibosADRISA = New RepRecibosADRISA
        rpt.Site = Me.Site
        Return rpt
    End Function
