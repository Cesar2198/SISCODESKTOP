...
Public Class repEnviosPagoRR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.repEnviosPagoRR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepEnviosPagoRR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repEnviosPagoRR = New repEnviosPagoRR
        rpt.Site = Me.Site
        Return rpt
    End Function
