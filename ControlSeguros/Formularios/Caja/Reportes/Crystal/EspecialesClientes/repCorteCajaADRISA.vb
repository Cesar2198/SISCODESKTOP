...
Public Class repCorteCajaADRISA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.repCorteCajaADRISA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepCorteCajaADRISA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repCorteCajaADRISA = New repCorteCajaADRISA
        rpt.Site = Me.Site
        Return rpt
    End Function
