...
Public Class repDetCorteCaja
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.repDetCorteCaja.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepDetCorteCaja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repDetCorteCaja = New repDetCorteCaja
        rpt.Site = Me.Site
        Return rpt
    End Function
