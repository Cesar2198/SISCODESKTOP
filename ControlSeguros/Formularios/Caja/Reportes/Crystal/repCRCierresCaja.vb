...
Public Class repCRCierresCaja
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.repCRCierresCaja.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepCRCierresCaja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repCRCierresCaja = New repCRCierresCaja
        rpt.Site = Me.Site
        Return rpt
    End Function
