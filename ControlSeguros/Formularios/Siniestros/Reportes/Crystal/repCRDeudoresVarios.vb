...
Public Class repCRDeudoresVarios
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "repCRDeudoresVarios.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.repCRDeudoresVarios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepCRDeudoresVarios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repCRDeudoresVarios = New repCRDeudoresVarios
        rpt.Site = Me.Site
        Return rpt
    End Function
