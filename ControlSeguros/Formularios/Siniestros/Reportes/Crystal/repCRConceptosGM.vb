...
Public Class repCRConceptosGM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.repCRConceptosGM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepCRConceptosGM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repCRConceptosGM = New repCRConceptosGM
        rpt.Site = Me.Site
        Return rpt
    End Function
