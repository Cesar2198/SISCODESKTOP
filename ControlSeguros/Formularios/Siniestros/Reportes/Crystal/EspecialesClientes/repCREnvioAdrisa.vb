...
Public Class repCREnvioAdrisa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.repCREnvioAdrisa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepCREnvioAdrisa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repCREnvioAdrisa = New repCREnvioAdrisa
        rpt.Site = Me.Site
        Return rpt
    End Function
