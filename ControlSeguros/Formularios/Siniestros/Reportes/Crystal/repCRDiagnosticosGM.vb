...
Public Class repCRDiagnosticosGM
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "repCRDiagnosticosGM.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sisco.repCRDiagnosticosGM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepCRDiagnosticosGM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repCRDiagnosticosGM = New repCRDiagnosticosGM
        rpt.Site = Me.Site
        Return rpt
    End Function
