...
Partial Class PlanSiniestrosNav
    ...
    Private Sub InitializeComponent()
        ...
        Me.FormularioEdicion = "PlanSiniestrosMan"
        Me.ListaAliasCampos = "Plan, Descripción, Póliza, IdProducto, Patrón, Producto"
        Me.ListaCampos = "IdPlan, Descripcion, IdPoliza, IdProducto, NumeroReclamo, (select Productos.Descr" & _
            "ipcion from Productos where productos.idproducto = SiniestroPlanes.IdProducto) a" & _
            "s Producto"
        Me.ListaCamposLlave = "IdPlan"
        Me.ListaCamposOcultos = "IdProducto"
        Me.Name = "PlanSiniestrosNav"
        Me.OrdenRegistros = "IdPlan"
        Me.Tabla = "SiniestroPlanes"
        Me.Text = "Planes de Siniestros"
