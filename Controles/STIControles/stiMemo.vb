...
#Region "Eventos"
    ...
    Private Sub txtControl_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        'evitaremos que se seleccione texto
        Me.txtControl.SelectionLength = 0
        Valor1 = Me.Text
    End Sub

    Private Sub txtControl_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub txtControl_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs)
    ...
    Private Sub btnFecha_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
