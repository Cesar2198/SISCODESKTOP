...
#Region "Eventos"
    ...
    Private Sub cboControl_EditValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboControl.EditValueChanged
        If CStr(Me.Valor) = Me.TextoNuevoItemL And HabilitarEvento = True Then
...
#Region "Propiedades"
    ...
    Dim intFilasVisibles As Integer = 0
    Public Property FilasVisibles() As Integer
        Get
            Return intFilasVisibles
        End Get
        Set(ByVal value As Integer)
            intFilasVisibles = value
        End Set
    End Property
            ...
            Try
                ...
                Else
                    If Not value Is Nothing Then
                        Dim Tipo As String = dtCombo.Columns(CampoValorL).DataType.Name.ToLower
    ...
    Public Function ValorColumna(ByVal ColumnName As String) As String
        Dim res As String = ""
        Try
            res = dtCombo.Select(cboControl.Properties.ValueMember & " = '" & Me.Valor & "'")(0).Item(ColumnName)
        Catch ex As Exception
            res = ""
        End Try
        Return res
    ...
    Public Property SelectIndex() As Integer
        Get
            Return cboControl.Properties.View.FocusedRowHandle
        End Get
        Set(ByVal value As Integer)
            cboControl.EditValue = cboControl.Properties.View.GetRowCellValue(value, cboControl.Properties.ValueMember)
        End Set
    End Property
    ...
    Public Sub Llenar_Combo(ByVal dtDatos As DataTable)
        ...
        Try
            ...
            Try
                ...
                cboControl.Properties.View.OptionsView.ShowAutoFilterRow = True
                cboControl.Properties.View.OptionsView.ShowHorzLines = False
